    ...
    function cc() {
        var age = parseInt(document.getElementById("age").value); //saves value of age
        var wtype = document.getElementById("wtype").value; //saves value of weight
        var foot = parseInt(document.getElementById("foot").value); //saves value of height (foot)
        var inch = parseInt(document.getElementById("inch").value); //saves value of height (inches)
        var cm = document.getElementById("cen").value;//variable for displaying cms conversion of height
        var weight = document.getElementById("weight").value; //saves the value of weight field
        if (age != '' && cm != '' && weight != '') {
            if (wtype == "pounds") {
                weight = parseInt(weight);
                weight = Math.round(weight / 2.2046);
            }
            var loa = document.getElementById("loa").value; // value of activeness
